...
public class TimerDataBatchJob implements Job {
    private static final Logger log = LoggerFactory.getLogger(TimerDataBatchJob.class);
    ...
    public void init() {
        job = SpringContextHolder.getBean("dataHandleJob");
