...
public class InterceptorConfigurerAdapter implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(getSingInterceptor()).addPathPatterns("/**").excludePathPatterns("/picture/**","/", "/login", "/css", "/scripts", "/images/**", "/test/**", "/plugins",
				"/error", "/static/**", "/logout", "/common/**", "/static/*","*.png","*.js","*.jpg");
